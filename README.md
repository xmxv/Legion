...
Core files for Legion bot. A modular bot with everything from admin, music, fun, minigame commands and much much more. 
...
If you have any issues, please don't create an issue on the repository as I will not be fixing it. 

If you have any questions, feel free to join the discord, also checkout my new project while you're at it. 

https://discord.gg/9eQBbxtFcz
